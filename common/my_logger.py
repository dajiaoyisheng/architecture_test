...
class Logger(object):
    def __init__(self, path, clevel=logging.DEBUG, Flevel=logging.DEBUG, colevel='INFO'):
        # 设置创建日志的对象
        # coloredlogs.install(level=colevel)  # 控制台日志带颜色打印
...
logger = Logger(os.path.dirname(os.path.dirname(__file__)) + '/logs/joinshare.log', logging.DEBUG, logging.DEBUG)
